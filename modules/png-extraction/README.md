...
* *PublicHeadersOnly*: If this value is set to true only public attributes are extracted. If you want only certain attributes to be extracted set this value to false and write the attributes you need in featureset.txt. If you want all the attributes(both public and private) set this value to false and leave the featureset.txt empty.
